...
const Aboutus = () => {
  return (
    <div className='lg:pt-[150px] sm:pt-[80px]'>
      <div className="container max-w-[1140px] mx-auto w-full px-3">
<div className="flex flex-row flex-wrap -mx-3">
    <div className="lg:w-1/2 px-3 flex justify-center mx-auto">
        <div className='lg:pr-[51px]'><img src={aboutimg} alt="img" className='w-full lg:h-[567px]' /></div>
    </div>
    <div className="lg:w-1/2 px-3 flex justify-center lg:block">
