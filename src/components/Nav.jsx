        ...
        <div className='flex items-center  py-[19px]  justify-between'>
          <a href="#home"><img src={logo} alt="img" /></a>
            <ul className={`flex gap-6 mobileView items-center ${ show ? "right-[-100%]" : "right-0"
                ...
                <li onClick={nav}><a href="#about"  className=' font-exo opacity-70 hover:opacity-100 duration-300  font-normal text-base text-[#131200]'>About Us</a></li>
                <li onClick={nav}><a href="#contact"  className=' font-exo opacity-70 hover:opacity-100 duration-300  font-normal text-base text-[#131200]'>Services</a></li>
