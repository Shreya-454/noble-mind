  ...
  return (
    <div className=' lg:pt-[150px] md:pt-20 pt-10'>
      <div className=' container max-w-[1140px] mx-auto w-full px-3'>
          <h2 className=' font-outfit text-3xl md:text-5xl text-center md:leading-[57.6px] text-[#131200] text-light  mb-4'>
          Frequently <span className=' font-semibold'>Asked Questions</span>
          </h2>
          <p className=' font-exo text-sm sm:text-base text-[#131200] opacity-70 text-center mb-7 md:mb-[52px]'>Lorem ipsum dolor sit amet consectetur. Orci augue mollis eu <span className='md:block'>volutpat mi leo. Nibh nisl consequat metus.</span></p>
