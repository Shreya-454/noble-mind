      ...
      <div className="container max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-3 w-full" id="contact" >
        ...
        <div>
          <div className="flex flex-col items-center">
            ...
            <button className=" bg-btn-gradient text-white px-3 py-2 font-outfit font-semibold" onClick={handlePopupClose}>Close</button>
          </div>
        </div>
      )}
            </form>
