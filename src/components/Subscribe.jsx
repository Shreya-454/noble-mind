          ...
          <div className=" max-w-[448px] mx-auto border border-solid border-[#FDFDFF33] p-2.5 bg-[#FFFFFF0D] rounded-md w-full">
            <form onSubmit={handleSubmit} className="flex justify-between">
              ...
              <input
                type="submit"
                value="Subscribe"
                className=" font-outfit text-white px-6 py-[14px] sm:text-base text-sm cursor-pointer  border border-solid border-[#FDFDFF] rounded-[4px] hover:bg-white focus-visible:bg-transparent  duration-300  hover:text-[#A854E9] hover:border-[#A854E9]"
              />
            </form>
          </div>
          {formErrors.email && (
